...
We'd love for you to contribute to our source code and to make Kepler.gl even better than it is
...
Help us keep Kepler.gl open and inclusive. Please read and follow our [Code of Conduct][coc].
...
* **Checkout Kepler.gl item** Take a look at the roadmap
* **Pick your item** Pick an item to execute
* **Claim the item** Reply in the ticket to claim the item, one of the member of the technical team will respond
...
* **Kepler.gl Version(s)** - is it a regression?
...
Here is a great example of a well defined issue: **Create an issue template**.
...
* Search [GitHub](https://github.com/uber/kepler.gl/pulls) for an open or closed Pull Request
...
* Run the Kepler.gl [unit][developers.tests-unit] and [E2E test][developers.tests-e2e] suites, and ensure that all tests
...
* In GitHub, send a pull request to `kepler.gl:master`. This will trigger the check of the
...
* If we suggest changes, then:
  ...
  * Re-run the Kepler.gl test suite to ensure tests are still passing.
...
[github-new-issue]: https://github.com/uber/kepler.gl/issues/new
[github]: https://github.com/uber/kepler.gl
[jsfiddle]: http://jsfiddle.net/
[plunker]: http://plnkr.co/edit
[stackoverflow]: http://stackoverflow.com/questions/tagged/Kepler.gl
